...
class NavigationBarandFilter extends react.Component
{
    render()
    {
        return (
            ...
            <Icon style={styles.icon} name="arrow-left" size={28} color="#000000" />
                <Text style={{fontSize:24,paddingLeft:20,paddingRight:'10%',marginTop:'3%'}}>Headphones</Text>
...
export default NavigationBarandFilter;
